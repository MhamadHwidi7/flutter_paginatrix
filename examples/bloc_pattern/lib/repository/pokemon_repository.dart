...
import 'package:shared/utils/paginatrix_logger.dart';
...
class PokemonRepository {
  ...
  /// [query] - Optional query criteria (search, filters, sorting)
  ///
  ...
  Future<Map<String, dynamic>> loadPokemonPage({
    ...
    try {
      ...
      PaginatrixLogger.logPaginationOperation(
        operation: 'Load Pokemon Page',
        page: currentPage,
      ...
      if (query != null) {
        PaginatrixLogger.logQueryCriteria(
      ...
      // Log API response
      PaginatrixLogger.logApiResponse(
      ...
      PaginatrixLogger.logInfo(
          'Fetching details for ${pokemonIds.length} Pokemon...');
      ...
      PaginatrixLogger.logPerformance(
        operation: 'Fetch Pokemon Details',
        duration: detailsStopwatch.elapsed,
        additionalMetrics: {
      ...
      PaginatrixLogger.logInfo(
        'Pagination: Page $currentPage/$totalPages, Has more: $hasMore, Returning ${pokemonList.length} Pokemon',
      );
